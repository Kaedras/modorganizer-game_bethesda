...
protected:
  ...
  void fetchInformationFields(FileWrapper& wrapper, uint32_t& width, uint32_t& height,
                              uint32_t& saveNumber, QString& playerName,
                              uint16_t& playerLevel, QString& playerLocation) const;
