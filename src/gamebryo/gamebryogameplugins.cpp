...
void GamebryoGamePlugins::writePluginLists(const IPluginList* pluginList)
{
  ...
  writePluginList(pluginList, m_Organizer->profile()->absolutePath() % u"/plugins.txt"_s);
  writeLoadOrderList(pluginList,
                     m_Organizer->profile()->absolutePath() % u"/loadorder.txt"_s);
                                    ...
                                    const QString& filePath, bool loadOrder)
{
  ...
  file->write(
      encoder.encode(u"# This file was automatically generated by Mod Organizer.\r\n"_s));
